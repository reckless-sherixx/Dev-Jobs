...
export default async function MyJobsPage() {
    ...
    return (
        <>
            {
                data.length === 0 ? (
                    <EmptyState title="No job post found" description="You don't have any job posts yet."
                        buttonText="Create a job post now!" href="/post-job" />
                ) : (
                    <Card>
                        <CardHeader>
                            <CardTitle>
                                    ...
                                    <TableBody>
                                        {data.map((listing) => (
                                            <TableRow key={listing.id}>
                                                <TableCell>
                                                    <Image src={listing.Company.logo} alt="logo of company" width={40} height={40} className="rounded-md size-10" />
                                                </TableCell>
                                                <TableCell>
